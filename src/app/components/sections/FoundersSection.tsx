    ...
    <section id="founders" className="founders">
      <div className="container">
        ...
        <div className="f-stats">
          <div className="f-stat">
            <div className="f-stat__value">
              <span className="f-stat__num" data-count={10}></span><span className="f-stat__plus">+</span>
            </div>
            <div className="f-stat__label">Years Teaching</div>
          </div>
          <div className="f-stat">
            <div className="f-stat__value">
              <span className="f-stat__num" data-count={1}></span><span className="f-stat__plus">+</span>
            </div>
            <div className="f-stat__label">AIR &lt; 100 Achievers</div>
          </div>
          <div className="f-stat">
            <div className="f-stat__value">
              <span className="f-stat__num" data-count={6}></span><span className="f-stat__plus">+</span>
            </div>
            <div className="f-stat__label">Cities Taught</div>
          </div>
          <div className="f-stat">
            <div className="f-stat__value">
              <span className="f-stat__num" data-count={1000}></span><span className="f-stat__plus">+</span>
            </div>
        ...
        <div className="fs-cta">
          ...
          <p className="fs-cta-sub">Book a quick discovery call — we’ll help you choose the right path for JEE/NEET.</p>
